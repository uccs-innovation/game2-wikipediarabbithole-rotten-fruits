...
if(place_meeting(x,y, obj_honey_puddle) == true)
{
	...
	{ // only play sound once
		audio_play_sound(snd_HoneyWalk,1,0);
		inHoney = true;
		alarm_set(4,45);
	}
	moveSpeed = halfSpeed;
...
if(place_meeting(x,y, obj_oil_puddle) == true)
{
	if (!inOil)
	{ // only play sound once
		audio_play_sound(snd_OilWalk,1,0);
		inOil = true;
		alarm_set(3,45);
	}
stunned = true;
